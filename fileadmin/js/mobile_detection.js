...
var mobile_url = 'http://www.IHRESEITE.de/index.php?id=ID_der_mobilen_Startseite';
...
if (wertdescookies == null) {
  ...
  if (wertdescookies == 1){
    ...
    if (check == true){
      ...
      var mobile_site_base_url = mobile_url.substr( 0, ( mobile_url.indexOf('.de') + 3 ) );
